...
{
  raspimouse_msgs__msg__Switches * msg = (raspimouse_msgs__msg__Switches *)malloc(sizeof(raspimouse_msgs__msg__Switches));
  if (!msg) {
    return NULL;
  }
...
raspimouse_msgs__msg__Switches__Sequence__init(raspimouse_msgs__msg__Switches__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raspimouse_msgs__msg__Switches *)calloc(size, sizeof(raspimouse_msgs__msg__Switches));
    if (!data) {
      return false;
    }
...
{
  raspimouse_msgs__msg__Switches__Sequence * array = (raspimouse_msgs__msg__Switches__Sequence *)malloc(sizeof(raspimouse_msgs__msg__Switches__Sequence));
  if (!array) {
    return NULL;
  }
